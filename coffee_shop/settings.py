...
SECRET_KEY = 'django-insecure-))8g8k$)f86y#2y8gwg($xcn8g)!vjs-n^on2%fhmpj!#99pi6'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'shop', 'static')]  # Correct path to shop's static directory
